...
export default function AdvancedParticles() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener("mousemove", (e) => effect.handleMouse(e))
      window.removeEventListener("touchmove", (e) => effect.handleTouch(e))
      window.removeEventListener("mousedown", () => (effect.mouse.pressed = true))
      window.removeEventListener("mouseup", () => (effect.mouse.pressed = false))
      window.removeEventListener("touchstart", () => (effect.mouse.pressed = true))
      window.removeEventListener("touchend", () => (effect.mouse.pressed = false))
    }
  }, [])
