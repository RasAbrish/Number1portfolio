...
const projects: Project[] = [
  {
    ...
    description: "Modular content platform built for structured publishing and team workflows.",
    longDescription: "Built a modular Headless CMS focused on scalable content operations. Implemented role-based access, content administration flows, and a clean dashboard experience to support production-ready publishing across teams.",
  ...
  },
  {
    ...
    description: "Corporate digital platform for a chemical supply company with global-facing positioning.",
    longDescription:
      "Developed and deployed a modern, responsive website for YAB Chemicals to strengthen brand visibility and digital presence. Built a clean UI architecture, improved content structure for services and products, and delivered a stable production-ready frontend.",
  ...
  },
  {
    ...
    title: "FuelFinder",
    description:
      "Safaricom Talent Cloud MVP for real-time fuel discovery and station availability.",
    longDescription:
      "Built and shipped a real-time fuel discovery MVP during the Safaricom Talent Cloud program using React, Node.js, Express, and PostgreSQL. Implemented responsive UI, backend APIs, and production deployment practices. The solution won 2nd place for innovation.",
    tags: ["React", "Node.js", "PostgreSQL", "Redis", "Google Maps"],
    link: "https://fuel-finder-frontend.onrender.com/",
    company: "Gebeya Inc (Safaricom Program)",
    role: "Full Stack Developer",
    duration: "3 months",
  ...
  },
  {
    ...
    longDescription:
      "Contributed as a frontend developer to a house rent management system serving operational workflows for housing and banking stakeholders. Built and refined user-facing modules, improved usability, and supported reliable delivery through close collaboration with the engineering team.",
  ...
  },
   {
    ...
    longDescription:
      "Developed an end-to-end full-stack platform to digitize rental agreement management for Addis Ababa. Replaced manual workflows with secure digital processes for agreements, tenant records, and administration. Built with React, Node.js, Zod, and Docker, and presented to a city sub-administration for potential rollout.",
    tags: ["React", "TypeScript", "Node.js", "PostgreSQL", "Tailwind CSS"],
